...
public class ResponseData<T> implements Serializable {
    ...
    public static <T> ResponseData<T> fail() {
        return new ResponseData<>(TechneCode.FAIL);
    }
    ...
    public static <T> ResponseData<T> fail(String message) {
        return new ResponseData<>(TechneCode.FAIL.getCode(), message);
    }
    ...
    public static <T> ResponseData<T> fail(String message, Object[] args) {
        return new ResponseData<>(TechneCode.FAIL.getCode(), message, args);
    }
    ...
    public static <T> ResponseData<T> retExist(boolean flag, Object[] args) {
        return flag ? retData(TechneCode.IS_EXIST, null, args) : retData(TechneCode.NOT_EXIST, null, args);
    }

    private ResponseData() {
        this.init(TechneCode.SUCCESS, null);
    }
    ...
    private ResponseData(T data) {
        this.init(TechneCode.SUCCESS, data);
    }
    ...
    private void init(int code, String message, T data, Object[] args) {
        this.code = code;
        this.message = TechneUtil.formatMessage(message, args);
        this.data = data;
    ...
    public static <T> ResponseData<T> instance(String message) {
        return instance(TechneCode.FAIL.getCode(), message);
    }
