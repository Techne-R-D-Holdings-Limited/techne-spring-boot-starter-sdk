...
import com.technehq.boot.annotation.CurrencyConversion;
    ...
    protected Formatter<BigDecimal> getFormatter(CurrencyConversion annotation) {
        return new Formatter<>() {
            ...
            public String print(BigDecimal value, Locale locale) {
                return NumberUtil.decimalFormat(annotation.pattern(), TechneUtil.currencyToYuan(value));
            }

            @Override
            public BigDecimal parse(String text, Locale locale) throws ParseException {
                return TechneUtil.currencyToCent(NumberUtil.toBigDecimal(text));
            }
        };
    }
