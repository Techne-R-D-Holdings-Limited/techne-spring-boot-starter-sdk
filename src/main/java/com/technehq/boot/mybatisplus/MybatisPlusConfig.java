...
import com.technehq.boot.mybatisplus.typehandler.GeoPointTypeHandler;
import com.technehq.boot.mybatisplus.typehandler.LocaleTypeHandler;
import com.technehq.boot.mybatisplus.typehandler.TechneInstantTypeHandler;
import com.technehq.boot.mybatisplus.typehandler.ZoneIdTypeHandler;
...
public class MybatisPlusConfig {
    ...
    public ConfigurationCustomizer mybatisPlusConfigurationCustomizer() {
        return configuration -> {
            ...
            typeHandlerRegistry.register(TechneInstantTypeHandler.class);
            typeHandlerRegistry.register(GeoPointTypeHandler.class);
            typeHandlerRegistry.register(LocaleTypeHandler.class);
            typeHandlerRegistry.register(ZoneIdTypeHandler.class);
        };
    }
