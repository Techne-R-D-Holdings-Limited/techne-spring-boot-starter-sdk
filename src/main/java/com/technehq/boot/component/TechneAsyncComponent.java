...
import com.technehq.boot.pojo.basic.TbSysLog;
...
public class TechneAsyncComponent {
     ...
     */
    public void insertSysLog(TechneLog techneLog, Object loginId, String clientIp, String userAgent,
        ...
        try {
            ...
            tbSysLog.setLogType(techneLog.logType().name());
            ...
            log.error("TechneAsyncComponent.insertSysLog --> e: ", e);
        }
    }
    ...
    private boolean successful(String responseData) {
        ...
        return GsonUtil.fromJson(responseData, ResponseData.class).getCode() == TechneCode.SUCCESS.getCode();
    }
