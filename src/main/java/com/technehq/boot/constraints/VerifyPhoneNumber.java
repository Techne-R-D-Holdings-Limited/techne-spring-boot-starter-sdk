...
import com.technehq.boot.constraintvalidators.VerifyPhoneNumberValidator;
import com.technehq.boot.jackson.PhoneNumberDeserializer;
...
public @interface VerifyPhoneNumber {
     ...
     * @return msg
     */
    String message() default TechneCode.MOBILE_VALIDATION_CODE_ERROR_STR;
