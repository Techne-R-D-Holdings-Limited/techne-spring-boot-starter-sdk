...
import com.technehq.boot.config.satoken.TechneSaSignTemplate;
import com.technehq.boot.constants.TechneCode;
import com.technehq.boot.exception.TechneException;
import com.technehq.boot.mybatisplus.ColumnResolverWrapper;
import com.technehq.boot.pojo.bo.GeoPointBO;
...
public final class TechneUtil {
    ...
    public static String getRealAddressByIp(String ip) {
        try {
            ...
            log.error("TechneUtil.getRealAddressByIp --> e: ", e);
            return null;
        }
    }
    ...
    public static String signParams() {
        return ((TechneSaSignTemplate) SaManager.getSaSignTemplate()).createSign(SaHolder.getRequest());
    }
    ...
    public static String formatMessage(String message, Object... args) {
        ...
        if (SpringMVCUtil.isWeb()) {
            ...
            resourceBundleMessageSource.setBasenames("ValidationMessages", "techne-i18n/messages");
    ...
    public static void coordinatesWithinRadius(GeoPointBO sourcePoint, GeoPointBO targetPoint, double radius, String message) {
        if (!isCoordinatesWithinRadius(sourcePoint, targetPoint, radius)) {
            throw new TechneException(message);
        }
    }
    ...
    public static String verifyAppleIdAuthCode(String keyId, String clientId, String teamId, String redirectUrl,
        ...
        try (HttpResponse execute = HttpUtil.createPost("https://appleid.apple.com/auth/token")
            ...
            log.info("TechneUtil.verifyAppleIdAuthCode --> body: {}", body);
    ...
    public static String verifyFacebookAuthCode(String clientId, String clientSecret, String redirectUrl, String authorizationCode) {
        try (HttpResponse oauthExecute = HttpUtil.createGet("https://graph.facebook.com/v22.0/oauth/access_token")
            ...
            log.info("TechneUtil.verifyFacebookAuthCode --> oauthBody: {}", oauthBody);
            ...
            if (StrUtil.isNotBlank(accessToken)) {
                try (HttpResponse appExecute = HttpUtil.createGet("https://graph.facebook.com/oauth/access_token")
                    ...
                    log.info("TechneUtil.verifyFacebookAuthCode --> appBody: {}", appBody);
    ...
    public static String decryptByPrivateKey(String data) {
        try {
            ...
            throw new TechneException(TechneCode.PARAMETER_ERROR);
        }
    }
