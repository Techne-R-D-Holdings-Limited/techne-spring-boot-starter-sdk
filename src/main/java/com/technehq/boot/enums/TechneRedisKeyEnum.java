package com.technehq.boot.enums;

import com.technehq.boot.constants.TechneRedisKeyFormat;
 ...
 */
public enum TechneRedisKeyEnum implements TechneRedisKeyFormat {
